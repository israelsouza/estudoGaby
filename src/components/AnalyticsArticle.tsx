  ...
  const features = [
    {
      title: "Dominância",
      description:
        "Pessoas determinadas, independentes, automotivadas, com foco em resultados, que podem desconsiderar opiniões alheias.",
    },
    {
      title: "Influência",
      description:
        "Indivíduos sociáveis, entusiasmados, autoconfiantes, excelentes em relacionamentos interpessoais, comunicativos, mas podem ser impulsivos.",
    },
    {
      title: "Estabilidade",
      description:
        "Pessoas pacientes, persistentes, ponderadas, detalhistas, planejadoras, organizadas, mas podem ser resistentes a mudanças.",
    },
    {
      title: "Conformidade",
      description:
        "Indivíduos exatos, analíticos, curiosos, disciplinados, muito presos a regras e procedimentos.",
    },
  ];
    ...
    <div className="py-20 bg-gradient-to-b from-muted to-muted max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mb-4 text-lg text-justify text-muted-foreground max-w-3xl mx-auto">
          ...
          guiadas por ordem e controle, sendo detalhistas e organizadas,
          enquanto as de Influência buscam harmonia e gostam de trabalhar em
          equipe, fortalecendo as relações interpessoais.
        </p>
      </div>
    </div>
  );
